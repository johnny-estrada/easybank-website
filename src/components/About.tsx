        ...
        <div className="relative isolate -z-10">
          ...
          >
            <div
              ...
              className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[hsl(136, 65%, 51%)] to-[hsl(192, 70%, 51%)] opacity-30"
            />
          </div>
          <div className="overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-24">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-4xl tracking-tight text-slate-700 sm:text-6xl">
                    We’re changing the way people bank.
                  </h1>
                  <p className="relative mt-6 text-lg leading-8 text-zinc-400 sm:max-w-md lg:max-w-none">
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-48">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-center text-lg font-semibold leading-8 text-gray-900">
              Trusted by the world’s top organzations
            </h2>
